...
- 🔐 **用户认证与授权** - JWT 双 token 刷新、RBAC 权限体系
...
- **API 就绪探针 (readiness)**: http://localhost:3000/api/health/ready（探测数据库连通性）
...
- [x] 用户管理系统基础功能
- [x] 用户认证和授权系统
- [x] 认证安全加固（令牌撤销、登录失败锁定、CORS 白名单、HTTP 超时）
- [x] 博客文章 CRUD 功能
- [x] 文章分类与标签管理
- [x] 评论系统
- [x] 点赞收藏与用户关注
- [x] 搜索功能（MySQL ngram 全文索引）
- [x] 文件上传和图片管理
