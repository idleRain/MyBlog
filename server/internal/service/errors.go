...
// ErrUsernameTaken 用户名已被占用的哨兵错误，handler 层经 errors.Is 识别后映射为 400。
var ErrUsernameTaken = errors.New("用户名已存在")

// ErrEmailTaken 邮箱已被其他账号占用的哨兵错误，handler 层经 errors.Is 识别后映射为 400。
var ErrEmailTaken = errors.New("邮箱已被其他用户使用")
