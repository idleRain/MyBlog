<script lang="ts">
	...
	import type { WithoutChildrenOrChild } from "$lib/utils/index.ts.js";
...
<DrawerPortal {...portalProps}>
	...
	>
		<div
			class="mx-auto mt-4 hidden h-1 w-[100px] shrink-0 rounded-full bg-muted group-data-[vaul-drawer-direction=bottom]/drawer-content:block mx-auto hidden shrink-0 bg-muted group-data-[vaul-drawer-direction=bottom]/drawer-content:block"
		></div>
		{@render children?.()}
	</DrawerPrimitive.Content>
</DrawerPortal>
